...
```bash
SOCKET_DIR="${TMPDIR:-/tmp}/AgentZ-tmux-sockets"
mkdir -p "$SOCKET_DIR"
SOCKET="$SOCKET_DIR/AgentZ.sock"
SESSION=AgentZ-python
...
- Default socket dir: `${TMPDIR:-/tmp}/AgentZ-tmux-sockets`
- Default socket path: `"$SOCKET_DIR/AgentZ.sock"`
