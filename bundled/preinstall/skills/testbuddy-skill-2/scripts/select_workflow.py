...
DEFAULT_WORKFLOWS = {
    "框架生成": "workflows/framework-generation.md",
    "模块生成": "workflows/feature-generation.md",
    "场景生成": "workflows/scene-generation.md",
    "测试点生成": "workflows/testpoint-generation.md",
    "用例生成": "workflows/case-generation.md",
}
