const en = {
  ...
  app: {
    ...
    chat: "Chat",
    chatTitle: "Toggle side panel (Chat / Graph)",
    sidePanelTitle: "IDE side panel",
    sidePanelChat: "Chat",
    sidePanelGraph: "Graph",
  ...
  agent: {
    ...
    repoWikiHint: "Generate repo docs and knowledge graph (writes to .agentz/)",
    repoWikiOverview: "Quick overview",
    repoWikiOverviewHint: "Module/architecture markdown from the code index (.agentz/REPO_WIKI.md)",
    repoWikiGraph: "Rebuild graph index",
    repoWikiGraphHint: "Background CodeGraph-style index → .agentz/graph.db (no UI)",
    repoWikiGraphDone: "Graph index ready — {{nodes}} nodes, {{edges}} edges",
    repoWikiGraphQueued: "Graph index queued — building in background",
    repoWikiGraphIndexing: "Indexing…",
    repoWikiGraphReadyShort: "Ready · {{nodes}} nodes",
    repoWikiGraphEmpty: "Not indexed yet",
    repoWikiGraphError: "Index failed",
    repoWikiGraphStatusIndexing: "Knowledge graph — indexing in background",
    repoWikiGraphStatusReady: "Knowledge graph ready — {{nodes}} nodes indexed",
    graphDashboardTitle: "Code knowledge graph",
    graphPanelDragHint: "Drag title bar to move panel",
    graphPanelResizeHint: "Drag left edge to resize",
    graphClose: "Close",
    graphCloseHint: "Press Esc or click × to close",
    graphOpenFileHint: "Graph closes when you open a file so you can edit",
    graphFiles: "files",
    graphModules: "modules",
    graphSearchPlaceholder: "Search dirs or modules…",
    graphViewStructure: "Structure",
    graphViewModule: "Top modules",
    graphModuleListHint:
      "Structure view aggregates file imports by directory; top-module view helps when cross-module depends edges exist.",
    graphInternalImportsShort: "internal imports",
    graphBreadcrumbRoot: "Repo",
    ...
    graphAgentHint:
      "Agents auto-read `.agentz/AGENT_CODING_BRIEF.md`. Use `graph_search`, `@graph`, then `codebase_search` before editing.",
    graphPersonaLabel: "View as",
    ...
    graphNodeId: "Node id",
    graphEdgeStats: "depends in {{in}} / out {{out}}",
    graphTour: "Tour",
    graphTourStep: "Stop {{current}}/{{total}}: {{module}}",
    graphTourPrev: "Previous",
    graphTourNext: "Next",
    ...
    graphDependsOn: "Depends on modules",
    graphImportedBy: "Imported by modules",
    graphNoCrossModuleDeps:
      "No cross-module imports (common for split frontend/backend — see hub files below)",
    graphHubFiles: "Hub files (high fan-in inside module)",
    graphHubFilesHint: "Many files import these — read before editing shared code.",
    graphHubImporters: "imported by {{count}} file(s) in this module",
    graphLayer: "Dominant layer",
    graphModuleFiles: "Files in module",
    graphOpenFile: "Open file",
    graphEmpty: "No graph yet — click Refresh to generate",
    graphLegendChanged: "Changed",
    graphLegendImpacted: "Impacted",
    graphImpact: "Impact analysis",
    graphImpactHint: "Analyze how the current task branch affects the codebase",
